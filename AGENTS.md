...
Use **Conventional Commits** format (`feat:`, `fix:`, `chore:`, `docs:`, `refactor:`, `test:`). Keep commits small and scoped — one logical change per commit. Never include `Co-authored-by:` trailers.
