...
// JADE-MODERNIZATION-DEFERRED:TRY_WITH_RESOURCES Extremely broad pattern (1832 flags), deferred for targeted future review
				...
				if (stream == null) {
					...
					stream = new PrintStream(f, StandardCharsets.UTF_8);
...
// JADE-MODERNIZATION-DEFERRED:TRY_WITH_RESOURCES Extremely broad pattern (1832 flags), deferred for targeted future review
				...
				if (ci == null) {
					...
					PrintStream stream = new PrintStream(f, StandardCharsets.UTF_8);
...
// JADE-MODERNIZATION-DEFERRED:TRY_WITH_RESOURCES Extremely broad pattern (1832 flags), deferred for targeted future review
				if (summaryFile == null) {
					...
					summaryFile = new PrintStream(f, StandardCharsets.UTF_8);
