...
Rule: TLS_ANON_CIPHER_DISABLED | blast_class: body-local | shards: 1
...
|----------|-------|----------------|----------------|--------------|
| TLS_ANON_CIPHER_DISABLED-body-local-001 | body-local | True | 2 | 2 |
...
### TLS_ANON_CIPHER_DISABLED-body-local-001

1. `python .claude/skills/jade-core-orchestrator/scripts/shard_checkpoint.py --artifacts-dir migration-runs/jade-8-to-11-v2/artifacts --rule-id TLS_ANON_CIPHER_DISABLED --shard-id TLS_ANON_CIPHER_DISABLED-body-local-001 --workspace migration-runs/jade-8-to-11-v2/workspace --create`
2. Dispatch the subagent for this shard.
3. `python .claude/skills/jade-core-verification/scripts/verify_shard.py --artifacts-dir migration-runs/jade-8-to-11-v2/artifacts --rule-id TLS_ANON_CIPHER_DISABLED --shard-id TLS_ANON_CIPHER_DISABLED-body-local-001`
4. `python .claude/skills/jade-core-verification/scripts/gate_signatures.py --artifacts-dir migration-runs/jade-8-to-11-v2/artifacts --rule-id TLS_ANON_CIPHER_DISABLED --shard-id TLS_ANON_CIPHER_DISABLED-body-local-001 --before-graph migration-runs/jade-8-to-11-v2/artifacts/03.5-knowledge-graph.json --after-graph migration-runs/jade-8-to-11-v2/artifacts/03.5-knowledge-graph-after-TLS_ANON_CIPHER_DISABLED-body-local-001.json`
5. `python .claude/skills/jade-core-rule-dispatcher/scripts/dispatcher.py --artifacts-dir migration-runs/jade-8-to-11-v2/artifacts --rule-id TLS_ANON_CIPHER_DISABLED --record-agent-result --shard-id TLS_ANON_CIPHER_DISABLED-body-local-001 --result-file migration-runs/jade-8-to-11-v2/artifacts/06-agent-result-TLS_ANON_CIPHER_DISABLED-TLS_ANON_CIPHER_DISABLED-body-local-001.json`
6. `python .claude/skills/jade-core-orchestrator/scripts/shard_checkpoint.py --artifacts-dir migration-runs/jade-8-to-11-v2/artifacts --rule-id TLS_ANON_CIPHER_DISABLED --shard-id TLS_ANON_CIPHER_DISABLED-body-local-001 --workspace migration-runs/jade-8-to-11-v2/workspace --accept`
7. `python .claude/skills/jade-core-orchestrator/scripts/shard_checkpoint.py --artifacts-dir migration-runs/jade-8-to-11-v2/artifacts --rule-id TLS_ANON_CIPHER_DISABLED --shard-id TLS_ANON_CIPHER_DISABLED-body-local-001 --workspace migration-runs/jade-8-to-11-v2/workspace --rollback --reason "<why>"`
...
```
python .claude/skills/jade-core-orchestrator/scripts/orchestrator.py --config migration-runs/jade-8-to-11-v2/artifacts/00-run-config.json --run
```
