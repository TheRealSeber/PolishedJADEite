...
// JADE-FLAG:TLS_ANON_CIPHER_DISABLED hard-coded anonymous TLS cipher suite; disabled by the default jdk.tls.disabledAlgorithms value in JDK 11 and never negotiated even when set explicitly 0.95
