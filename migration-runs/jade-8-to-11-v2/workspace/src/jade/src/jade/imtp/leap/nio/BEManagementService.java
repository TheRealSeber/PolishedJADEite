...
// JADE-FLAG:DIAMOND_OPERATOR Java 7 introduced type inference for generic instance creation (the diamond operator), allowing empty angle brackets <> to replace explicit type arguments when the compiler can infer them from context. 1.0
...
// JADE-MODERNIZATION-DEFERRED:TRY_WITH_RESOURCES Extremely broad pattern (1832 flags), deferred for targeted future review
			...
			oldLoopManager.stop();
// JADE-MODERNIZATION-DEFERRED:THREAD_STOP_DISABLED Custom .stop() call - not Thread.stop(); no change needed
		}
